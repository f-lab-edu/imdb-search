...
import { ProducerCommand, WorkerResponseType, type MainRequestPayload } from "./messages.js";
...
(async () => {
  ...
  const producer = new TaskProducer(RedisDB, config.task, config.datasets, batchId);
